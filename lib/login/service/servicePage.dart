...
class HttpService {
  ...
  static login(email, password, context) async {
    ...
    if (response.statusCode == 200) {
      ...
      await pref.setString("id", Users['user']['id'].toString());
      await pref.setString("name", Users['user']['name'].toString());
      await pref.setString("no_hp", Users['user']['no_hp'].toString());
      await pref.setString("alamat", Users['user']['alamat'].toString());
      await pref.setString("role_id", Users['user']['role_id'].toString());
      await pref.setString("jabatan_id", Users['user']['jabatan_id'].toString());
